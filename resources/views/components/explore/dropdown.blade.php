<div id="explore-dropdown" class="hidden sm:hidden absolute top-0 left-0 w-full px-10 border-t-2 z-[9999]">
    <div class="bg-white w-full grid lg:grid-cols-4 gap-4 sm:grid-cols-3">
        <div>
        ...
        <div>
            <h2 class="text-lg">Rocket Science</h2>
            <ul>
                <li></li>
            </ul>
        </div>
